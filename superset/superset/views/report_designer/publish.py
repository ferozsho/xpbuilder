...
VIZ_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "treemap": {"label": _("Treemap"), "kind": "aggregate", "viz": "treemap"},
    "sunburst": {"label": _("Sunburst"), "kind": "aggregate", "viz": "sunburst"},
    ...
    "histogram": {"label": _("Histogram"), "kind": "aggregate", "viz": "histogram"},
    "scatter": {"label": _("Scatter"), "kind": "aggregate", "viz": "scatter"},
    "big_number": {
        "label": _("Big Number"),
        "kind": "metric",
        "viz": "big_number",
