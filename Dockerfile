#
# OpenXpertz XPBuilder runtime image.
#
...
# OpenXpertz configuration, branding, and bootstrap scripts.
#
...
# OpenXpertz patches (docker/patches/*.patch) to it. Every later stage
...
LABEL org.opencontainers.image.title="OpenXpertz XPBuilder" \
      org.opencontainers.image.description="Versioned OpenXpertz Advanced BI runtime (source-built Apache Superset 6.1.0)" \
