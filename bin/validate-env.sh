...
required_keys=(
    ...
    MOODLE_NETWORK MOODLE_DB_NAME MOODLE_REPORTING_USER MOODLE_REPORTING_PASSWORD
...
secret_keys=(
    MOODLE_REPORTING_PASSWORD MARIADB_ROOT_PASSWORD MARIADB_REPLICATION_PASSWORD
